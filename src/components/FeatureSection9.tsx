...
const features = [
  {
    ...
    description: "Каждое изделие создаётся по точным замерам пациента — никаких стандартных размеров.",
  },
  {
    icon: "HeartPulse",
    title: "Специализация на ДЦП",
    description: "Преимущественно работаем с детьми с ДЦП и нарушениями опорно-двигательного аппарата.",
  },
  {
    icon: "ShieldCheck",
  ...
  {
    icon: "Award",
    title: "Точное изготовление",
    description: "Каждый ортоаппарат проходит примерку и корректировку. Срок изготовления — от 20 дней.",
  },
]
