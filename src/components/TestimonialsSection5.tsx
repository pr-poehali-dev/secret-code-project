...
const testimonials = [
  {
    quote: "Долго мучилась с болью в стопах, обошла много мест — нигде не помогали. В ОртоЦентр сделали ортоаппарат по меркам, и уже через неделю боль ушла. Рекомендую всем!",
