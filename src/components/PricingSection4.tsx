...
const plans = [
  {
    ...
    features: [
      { name: "Консультация специалиста", tooltip: "Первичный осмотр и оценка состояния пациента" },
      { name: "Ортоаппарат базовой конструкции", tooltip: "Ортоаппарат по индивидуальным меркам" },
  ...
  },
  {
    ...
    badge: "Популярный",
    features: [
      { name: "Углублённая диагностика", tooltip: "Детальная оценка состояния и параметров пациента" },
      { name: "Ортоаппарат из термопласта или кожи", tooltip: "Материалы премиального качества с долгим сроком службы" },
      { name: "Коррекция под конкретный диагноз", tooltip: "Учитываем ДЦП, нарушения ОПДА, параличи и другие диагнозы" },
  ...
  },
  {
    ...
    features: [
      ...
      { name: "Ортоаппарат сложной конструкции на заказ", tooltip: "Аппараты на голеностоп, колено, всю ногу" },
      { name: "3D-сканирование", tooltip: "Точная цифровая модель для идеальной посадки" },
