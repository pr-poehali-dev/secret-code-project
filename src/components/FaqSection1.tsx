...
const faqs = [
  {
    question: "Чем индивидуальный ортоаппарат отличается от готового?",
    answer:
      "Готовые аппараты — стандартные, они не учитывают анатомию конкретного пациента. Индивидуальные ортоаппараты изготавливаются по точным меркам и медицинским показаниям, поэтому дают реальный терапевтический эффект.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Ортоаппараты из термопласта служат 2–3 года при правильном уходе. Изделия из углеволокна и металла — 3–5 лет. Мы проводим бесплатный осмотр и коррекцию по необходимости.",
  },
  {
    question: "Можно ли оплатить ортоаппарат по электронному сертификату ТСР?",
    answer:
      "Да! Мы принимаем оплату через электронные сертификаты технических средств реабилитации (ТСР). Это государственная программа, по которой инвалиды и люди с ограниченными возможностями здоровья получают средства на приобретение необходимых изделий. Для оплаты сертификатом уточните детали у нашего специалиста при записи.",
  },
]
